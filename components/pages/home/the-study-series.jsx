        ...
        <div className="the-study-series">
            <section className="the-study-series__hero" ref={heroRef}>
                ...
                <div className="the-study-series__hero-content">
                    <div className="the-study-series__brand">33 Studio Home</div>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-8">
                            <div className="the-study-series__intro-text">
                                <p>
                                    {locale === 'zh' ?
                                    '设计是一场持续的思考练习。The Study Series 是 33 Studio Home 对空间、材质与光影的实验性记录——它们不是完整的项目，而是设计过程中的片段、思考与探索。每一个画面都是关于比例、色彩、触感与氛围的研究，是我们对"生活艺术"的持续追问。' :
                                    locale === 'fr' ?
                                    'Le design est un exercice de réflexion continue. The Study Series est un enregistrement expérimental de 33 Studio Home sur l\'espace, les matériaux et la lumière—ce ne sont pas des projets complets, mais des fragments, des réflexions et des explorations du processus de conception. Chaque image est une étude sur la proportion, la couleur, la texture et l\'atmosphère, notre questionnement continu sur "l\'art de vivre".' :
                                    'Design is a continuous exercise in thinking. The Study Series is 33 Studio Home\'s experimental record of space, materials, and light—they are not complete projects, but fragments, thoughts, and explorations from the design process. Each image is a study of proportion, color, texture, and atmosphere, our continuous inquiry into the "art of living".'}
                                </p>
                            </div>
                        </div>
                    </div>
